    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: '#023046' }}>
            ...
            <View style={{ padding: 20 }}>
                ...
                >
                    <Text style={{ color: 'white', fontSize: 18, fontWeight: 'bold', marginRight: 5 }}>Puntos: {profile?.total_puntos ?? '0'}</Text>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 }}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => setSelectedTab('Aplicar')}
                    >
                ...
                {selectedTab === 'Funcionamiento' ? (
                    ...
                    >
                        ...
                        <Text style={{ marginTop: 10, fontSize: 14, color: '#023046', lineHeight: 22 }}>
                            ...
                            - Cada vez que pagues por una tutoría, se sumarán 50 puntos a tu perfil. Podrás verlos
                            reflejados en esta pantalla o en tu perfil de estudiante.{"\n\n"}
                            - Existe un ranking de puntos donde competirás con otros estudiantes y podrás recibir
                            recompensas, como descuentos en los pagos de tutorías.{"\n\n"}
                    ...
                    >
                        ...
                        <Text style={{ marginTop: 10, fontSize: 14, color: '#023046', lineHeight: 22 }}>
                            - Cuando tengas los puntos necesarios para canjearlos por cupones de descuento, estos
                            aparecerán en el apartado "Lista de cupones".{"\n\n"}
                            - Ingresa y selecciona el cupón que cumpla con los requisitos, es decir, aquel que tenga un
                            costo en puntos igual o menor a los que has acumulado.{"\n\n"}
                            - Ten en cuenta que los cupones no siempre están disponibles, por lo que es recomendable
                            canjearlos cuanto antes.{"\n\n"}
